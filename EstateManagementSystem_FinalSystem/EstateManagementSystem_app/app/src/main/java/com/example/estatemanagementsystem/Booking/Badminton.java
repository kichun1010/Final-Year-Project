...
public class Badminton extends AppCompatActivity implements DatePickerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String htmlString="<u>Badminton Court</u>";
                ...
                if (confirmation != null) {
                    try {
                        ...
                        startActivity(new Intent(this, PaymentDetails.class)
                                ...
                                .putExtra("type","Badminton Court 1")
                                .putExtra("date",date)
                                .putExtra("time",time)
