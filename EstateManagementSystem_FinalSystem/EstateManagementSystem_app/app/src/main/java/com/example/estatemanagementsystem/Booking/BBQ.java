...
public class BBQ extends AppCompatActivity implements DatePickerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String htmlString="<u>BBQ Site</u>";
