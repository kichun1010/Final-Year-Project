...
public class Tennis extends AppCompatActivity implements DatePickerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String htmlString="<u>Tennis Court</u>";
